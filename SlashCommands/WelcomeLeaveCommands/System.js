...
module.exports = {
  help: {
    name: "system",
    aliases: ["wllesys"],
    description: `Enable/disable welcome-leave system`,
    ...
    switch (saved?.acknowledged ?? false) {
      case true:
        let onembed = new moduleHolder.Modules.discord.EmbedBuilder()
          .setDescription(`${system ? moduleHolder.Modules.emojie.on : moduleHolder.Modules.emojie.off} Welcome-Leave system has been set to ${system}`)
