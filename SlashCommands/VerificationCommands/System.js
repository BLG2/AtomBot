...
module.exports = {
  help: {
    name: "system",
    aliases: ["vsys"],
    description: `Enable/disable verification system`,
    examples: [`system <on/off>`],
    permissions: 'ManageMembers',
    permissionsMe: ['ManageMembers'],
    ownerOnly: false,
    file: __filename,
    arguments: [
    ...
    switch (saved?.acknowledged ?? false) {
      case true:
        let onembed = new moduleHolder.Modules.discord.EmbedBuilder()
          .setDescription(`${system ? moduleHolder.Modules.emojie.on : moduleHolder.Modules.emojie.off} verification system has been set to ${system}`)
